...
object StockMovementModule {
    ...
    fun provideCreateStockVoucherUseCase(
        ...
        userAccessProvider: com.are.distribuidora.screenaccess.domain.repository.UserAccessProvider,
    ): CreateStockVoucherUseCase =
        CreateStockVoucherUseCase(movements, products, currentUser, userAccessProvider)
